            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 10),
                  Expanded(child: Text("130", style: TextStyle(color: Colors.white))),
                  Icon(Icons.access_time, color: Color.fromARGB(255, 223, 204, 152)),
                  SizedBox(width: 10),
                  Expanded(child: Text("30 Janeiro, 2024", style: TextStyle(color: Colors.white))),
                ],
              ),
              Padding(
                padding: EdgeInsets.all(8.0),
